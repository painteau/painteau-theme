...
<body <?php body_class(); ?>>
<?php wp_body_open(); ?>
<a class="skip-link" href="#main-content"><?php esc_html_e( 'Aller au contenu', 'painteau' ); ?></a>
...
<header class="site-header">
  <div class="site-header__inner">
    ...
    <nav id="site-navigation" class="site-nav" aria-label="<?php esc_attr_e( 'Navigation principale', 'painteau' ); ?>">
      <?php wp_nav_menu( [
    ...
    <div class="site-header__actions">
      <button class="nav-search-toggle" aria-label="<?php esc_attr_e( 'Rechercher', 'painteau' ); ?>" type="button" aria-expanded="false" aria-controls="nav-search-bar">
      ...
      <button class="nav-burger" aria-label="<?php esc_attr_e( 'Menu', 'painteau' ); ?>" type="button" aria-expanded="false" aria-controls="site-navigation">
  ...
  <div id="nav-search-bar" class="nav-search-bar" hidden>
    <form class="nav-search-form" role="search" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>">
      <span class="nav-search-form__prompt" aria-hidden="true">$</span>
      <label for="nav-search-input" class="screen-reader-text"><?php esc_html_e( 'Rechercher', 'painteau' ); ?></label>
      <input id="nav-search-input" class="nav-search-input" type="search" name="s"
