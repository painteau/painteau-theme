...
<div class="pt-section__inner">
  ...
  <header class="pt-archive-header">
    <h1 class="pt-page-title">// <?php echo wp_kses_post( get_the_archive_title() ); ?></h1>
    <?php if ( get_the_archive_description() ) : ?>
    <p class="pt-archive-desc"><?php echo wp_kses_post( get_the_archive_description() ); ?></p>
    <?php endif; ?>
  </header>
  ...
  <?php else : ?>
  <p class="pt-no-results"><?php esc_html_e( 'Aucun article dans cette archive.', 'painteau' ); ?></p>
  <?php endif; ?>
